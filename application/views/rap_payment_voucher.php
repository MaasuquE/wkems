...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-info ">
              ...
              <div class="invoice-box">
                  ...
                  <div class="details-box">
                    <div class="inner-details-box">
                      <div class="top-boxes">
                        ...
                        <div class="box-main box2">
                          <div class="box-main-innner-wrap">
                            ...
                            <p align="center" style="display: block;">Payment Voucher</p>
                          </div>
                        </div>
                        <div class="box-main box3">
                          <div class="box-main-innner-wrap">
                            <p>No &nbsp;&nbsp;&nbsp;<span><?= $rap_payment_no ?></span></p>
                          </div>
                        </div>
                      </div>
                      <p class="float-right">
                        <span>Date </span>
                        <span class="line-dot line-dot-1"><?= date('d-m-Y', strtotime($rap_payment_date)) ?></span>
                      ...
                      <p>
                        ...
                        <span class="line-dot line-dot-3"><?= $rap_payment_sum_of ?></span>
                        <span>امتیازی نشان</span>
                      </p>
                      <p>
                        <span>On Bank</span>
                        <span class="line-dot line-dot-4"><?= $rap_payment_on_bank ?></span>
                        <span>امتیازی نشان</span>
                        <span>/ Cheque No</span>
                        <span class="line-dot line-dot-5"><?= $rap_payment_cash_or_check_no ?></span>
                        <span>امتیازی نشان</span>
                      </p>
                      <p>
                        <span>Being of</span>
                        <span class="line-dot line-dot-6"><?= $rap_payment_beign_of ?></span>
                        <span>امتیازی نشان</span>
                      </p>
                ...
                <a href="<?php echo $base_url; ?>rap_payment/update/<?php echo $q_id; ?>" class="btn btn-success">
                  <i class="fa  fa-edit"></i> Edit
                </a>


                <a href="<?php echo $base_url; ?>rap_payment/print_voucher/<?php echo $q_id; ?>" target="_blank" class="btn btn-warning">
  ...
  <script>$(".rap_payment-view-active-li").addClass("active");</script>
