...
<table align="center" width="100%" height='100%'>
    ...
    <tr>
        ...
        <th colspan="4" rowspan="1"><b
                    style="text-transform: capitalize;"><?= $this->lang->line('purchase_invoice'); ?> </b>(<?= $purchase_status; ?>
            )
        </th>
    ...
    <tr>
        ...
        <th colspan="2" rowspan="1"><?= $this->lang->line('date'); ?> : <?php echo date("Y/m/d"); ?></th>
    </tr>
    ...
    <tr>
        ...
        foreach ($q2->result() as $res2) {
            ...
            echo "<td style=\"display: none;\">" . $res2->tax_name . "</td>";
