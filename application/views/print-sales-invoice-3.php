    ...
    <tr>
        <td colspan='14'>
            ...
            $q2 = $this->db->query("SELECT a.description,c.item_name, a.sales_qty,
                                  ...
                                  FROM 
                                  db_salesitems AS a,db_items AS c , db_units as d
                                  WHERE 
                                  d.id = c.unit_id and
...
//                echo "<td style='text-align: right;'>" . $res2->tax_amt . "</td>";
                ...
                //echo "<td colspan='2' class='text-right'>".number_format($before_tax,3)."</td>";
                //echo "<td class='text-right'>".$res2->price_per_unit."</td>";

                echo "<td colspan='2' class='text-right'>" . number_format($res2->total_cost, 3) . "</td>";
                echo "</tr>";
    ...
    <tr class="bg-sky">
        ...
        <td colspan="2" class='text-right'><b><?php echo number_format(($tot_sales_price), 3); ?></b></td>
        <td colspan="1" class='text-bold text-center'><?= number_format($tot_qty, 3); ?></td>
        <!--        <td colspan="1" class='text-bold text-center'></td>-->
        <!--        <td colspan="1" class='text-right'><b>-->
        <?php //echo number_format(($tot_tax_amt), 3); ?><!--</b></td>-->
        <td colspan="1" class='text-right'><b><?php echo number_format(($tot_discount_amt), 3); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format(($tot_total_cost), 3); ?></b></td>
    </tr>
    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('subtotal'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($tot_total_cost, 3); ?></b></td>
    </tr>


    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('other_charges'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($other_charges_amt, 3); ?></b></td>
    </tr>

    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('discount_on_all'); ?>
                (<?= $discount_to_all_input . " " . $discount_to_all_type; ?>)</b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($tot_discount_to_all_amt, 3); ?></b></td>
    </tr>

    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('grand_total'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($grand_total, 3); ?></b></td>
    </tr>

    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('invoice_paid'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($paid_amount, 3); ?></b></td>
    </tr>
    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('invoice_due'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($grand_total - $paid_amount, 3); ?></b></td>
    </tr>
    <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('customer_total_due'); ?></b></td>
        <td colspan="2" class='text-right'><b><?php echo number_format($total_due, 3); ?></b></td>
    </tr>
    ...
    <?php if (!empty($sales_invoice_footer_text)) { ?>
        <tr>
            <td colspan="14" style="text-align: center;font-size: 8px;">
