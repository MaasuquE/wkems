                                 ...
                                 <div class="col-md-12">
                                       <div class="box-body">
                                          <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="service_init" class="col-sm-4 control-label"><?= $this->lang->line('services'); ?><label class="text-danger">*</label></label>
                                                   <div class="col-sm-8">
                                                      <input type="text" class="form-control" id="expense_init" name="service_init" placeholder="" value="<?php print $service_init; ?>" >
                                                      <span id="service_init_msg" style="display:none" class="text-danger"></span>
                                                   </div>
                                                </div>
                                             </div>
