...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search payments</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>rap_payment/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_rap_payment'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('rap_payment_date'); ?></th>
                  <th><?= $this->lang->line('rap_payment_no'); ?></th>
                  <th><?= $this->lang->line('rap_payment_customer_name'); ?></th>
                  <th><?= $this->lang->line('rap_payment_sum_of'); ?></th>
                  <th><?= $this->lang->line('rap_payment_on_bank'); ?></th>
                  <th><?= $this->lang->line('rap_payment_cash_or_check_no'); ?></th>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('rap_payment/ajax_list')?>",
            "type": "POST",
