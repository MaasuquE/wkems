                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th style="display: none;" rowspan='2' style="width:7.5%"><?= $this->lang->line('tax_amount'); ?>(<?=$CURRENCY;?>)</th>
                                                   <th   style="display: none;"  rowspan='2' style="width:10%"><?= $this->lang->line('discount'); ?>(%)</th>
                                          ...
                                          <table  class="col-md-9">
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <?= $CI->currency('<b id="subtotal_amt" name="subtotal_amt">0.000</b>'); ?>
                                                   </h4>
                                                </th>
                                             </tr>
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <?= $CI->currency('<b id="other_charges_amt" name="other_charges_amt">0.000</b>'); ?>
                                                  </h4>
                                                </th>
                                             </tr>
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <?= $CI->currency('<b id="discount_to_all_amt" name="discount_to_all_amt">0.000</b>'); ?></h4>
                                                </th>
                                             </tr>
                                             <tr style="<?= (!is_enabled_round_off()) ? 'display: none;' : '';?>">
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <?= $CI->currency('<b id="round_off_amt" name="tot_round_off_amt">0.000</b>'); ?></h4>
                                                </th>
                                             </tr>
                                             <tr>
                                                ...
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <?= $CI->currency('<b id="total_amt" name="total_amt">0.000</b>'); ?></h4>
                                                </th>
                                             </tr>
                                          </table>
                                       </div>
                                                ...
                                                <?php 
                                                  if(!empty($return_id)){
                                                    ...
                                                    if($q3->num_rows()>0){
                                                      ...
                                                      $CI->currency(number_format($total_paid,3,'.',''))."</td><td></td></tr>";
                                                    }
                                                    else{
      ...
      <script>
         ...
         function calculate_tax(i){ //i=Row
          ...
          // tax        =(isNaN(parseFloat(tax)))         ? 0 : parseFloat(tax);
           ...
           $("#td_data_"+i+"_10").val('').val(per_unit_total.toFixed(3));

          // $("#td_data_"+i+"_5").val('').val(tax_amount.toFixed(3));
