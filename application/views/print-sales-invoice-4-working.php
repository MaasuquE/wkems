            ...
            <div class="invoice-box-inner">
                <div class="top-header">
                    <table class="table-header" style="width: 99%">
                        <tr>
                            ...
                            if ($company2 == "am"){
                                ?>
                                <img src="<?= base_url('uploads/company/sample-2.png'); ?>" alt="" width="70%;">
                            <?php } else { ?>
                    ...
                    <table id="customers" class="table-one bill-to-table" style="width: 99%">
                        <tr>
                            ...
                            <p><span><strong>Customer Address:</strong></span> <?php echo  $customer_address; ?></p>
                            </td>
                        </tr>
                    </table>
                ...
                <table id="customers"  class="items-list-table">
                    <tr>
                        ...
                        <th style="width: 0%;white-space: nowrap; display:none">Discount KD</th>
                        <th style="width: 24%;white-space: nowrap;">Amount KD</th>
                    </tr>
                    <?php
                    $i = 0;
                    $tot_qty = 0;
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?= $unit_price ?></td>
                            <td style="display:none"><?=  $discount_amt?></td>
                    ...
                    <div class="box-flex">
                        ...
                        <?php if (!empty($sales_invoice_footer_text)) { ?>
                            <div class="bootom-row">
                                <p style="text-align: left;"><strong>Note: If Cheque kindly prepares the cheque Name of Softline Technology.</strong></p>
                                 <p style="text-align: left;"><strong>
                                     All products to be exchanged must be returned in their original packaging condition along with Invoice within 14 days <p> from the date of purchase.</p></strong></p>
                            </div>
                        <?php } ?>
                    </div>
                    <table id="customers" class="table-one">
                        <tr>
                            <td>
                                ...
                                <p>Address:Kuwait – Qibla, Al Dawliah Commercial Centre, Mezzanine Floor, Office No.156/160-P.O.Box 29896 Safat 13009.
                                    Tel: 22479825, email sales@softlinekw.com</p>
                            </td>
                            <td>
                                
                                <p>Bank Accounts: A/C Name : Softline Technology Company <br>
                                Bank Name : Ahli United Bank <br>
                                Account Number : 12037414 <br>
                                IBAN Number : KW72BKME0000,0000,0000,0012037414  
