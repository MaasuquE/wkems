          ...
          <table class="table table-striped records_table table-bordered">
            ...
            <tbody>
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td style=\"display: none;\">".$res2->tax_name."[".$str."]</td>";
                  echo "<td class='text-right' style=\"display: none;\">".$CI->currency($res2->tax_amt)."</td>";
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td style="display: none;"><?=$CI->currency($tot_tax_amt);?></td>
                <td>-</td>
                <td><?= $CI->currency(number_format($tot_discount_amt,3,'.','')) ;?></td>
                <td><?= $CI->currency(number_format($tot_unit_total_cost,3,'.','')) ;?></td>
                          ...
                          <?php 
                            if(isset($purchase_id)){
                              ...
                              if($q3->num_rows()>0){
                                ...
                                echo "<tr class='text-right text-bold'><td colspan='4' >Total</td><td>".$CI->currency(number_format($total_paid,3,'.',''))."</td></tr>";
                              }
                              else{
