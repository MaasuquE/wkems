   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            <h1>
               <?= $page_title; ?>
               <small>Add/Update Commercial</small>
            </h1>
            <ol class="breadcrumb">
               <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
               <li><a href="<?php echo $base_url; ?>sales"><?= $this->lang->line('PInvoice'); ?></a></li>
               <li><a href="<?php echo $base_url; ?>sales/add">New commercial</a></li>
                  ...
                  <div class="box box-info ">
                     ...
                     <div class="box-body">
                        <div class="form-group">
                           <label for="customer_id" class="col-sm-2 control-label"><?= $this->lang->line('invoice'); ?><label class="text-danger">*</label></label>
                           <div class="col-sm-3">
                        ...
                        <div class="form-group">
                           <label for="supplier_id" class="col-sm-2 control-label"><?= $this->lang->line('shipper_name'); ?><label class="text-danger">*</label></label>
                           <div class="col-sm-3">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-12 ">
                              <div class="col-sm-12">
                                 <div class="box-body ">
                                    <div class="col-md-12">
                                       <h4 class="box-title text-info" style="margin-left: 15px;">Delivery terms: </h4>
                                       <hr>
                                       <div id="DeltermsContainer">
                           ...
                           <div class="col-xs-12 ">
                              <div class="col-sm-12">
                                 <div class="box-body ">
                                    <div class="col-md-12">
                                       <h4 class="box-title text-info" style="margin-left: 15px;">Payment terms: </h4>
                                       <hr>
