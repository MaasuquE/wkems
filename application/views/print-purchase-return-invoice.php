...
<table align="center" width="100%" height='100%'>
    <thead>
      ...
      <tr>
          ...
          <th colspan="4" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('purchase_return_invoice'); ?> </b></th>
      </tr>
      <tr>
...
<tfoot>
  ...
  <tr>
    ...
    <td colspan="1" style="text-align: right;" ><b><?php echo number_format(round($other_charges_amt),3,'.',''); ?></b></td>
  </tr>
  <tr>
    <td colspan="7" style="text-align: right;"><b><?= $this->lang->line('discount_on_all'); ?>(<?= $discount_to_all_input." ".$discount_to_all_type; ?>)</b></td>
    <td colspan="1" style="text-align: right;" ><b><?php echo number_format(round($tot_discount_to_all_amt),3,'.',''); ?></b></td>
  </tr>
  <tr>
    <td colspan="7" style="text-align: right;"><b><?= $this->lang->line('grand_total'); ?></b></td>
    <td colspan="1" style="text-align: right;" ><b><?php echo number_format(round($grand_total),3,'.',''); ?></b></td>
  </tr>
  <tr>
    <td colspan="8">
<?php
