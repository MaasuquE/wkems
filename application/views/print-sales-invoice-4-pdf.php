                ...
                <table id="customers"  class="items-list-table">
                    ...
                    ?>
                     <tr>
                        ...
                        <td colspan="2" style="text-align:right;font-size: 16px;border:none;"><span><strong>Total <?php echo number_format(($tot_total_cost), 3, '.', ''); ?> </strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="border:none;"></td>
                        <td colspan="2" style="text-align:right;font-size: 16px;border:none;"><span><strong>Discount <?php echo number_format(($discount_to_all_input), 3, '.', ''); ?> </strong></span></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="border:none;"></td>
                        <td colspan="2" style="text-align:right;font-size: 16px;border:none;"><span><strong><?= $this->lang->line('grand_total'); ?> <?php echo number_format(($grand_total), 3, '.', ''); ?> </strong></span></td>
                    </tr>
                </table>
                <div class="divFooter">
                    <div class="box-flex">
