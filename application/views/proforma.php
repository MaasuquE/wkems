...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
         ...
         <section class="content-header">
            ...
            <ol class="breadcrumb">
               ...
               <li><a href="<?php echo $base_url; ?>sales"><?= $this->lang->line('PInvoice'); ?></a></li>
               <li><a href="<?php echo $base_url; ?>sales/add">New proforma</a></li>
                  ...
                  <div class="box box-info ">
                     ...
                     <div class="box-body">
                        <div class="form-group">
                           ...
                           <label for="invoice_date" class="col-sm-2 control-label"><?= $this->lang->line('invoice_date'); ?> <label class="text-danger">*</label></label>
                           <div class="col-sm-3">
                              <div class="input-group date">
                                 <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                 </div>
                                 <input type="text" class="form-control pull-right datepicker" id="invoice_date" name="invoice_date" readonly onkeyup="shift_cursor(event,'sales_status')" value="<?= $sales_date; ?>">
                              </div>
                              <span id="invoice_date_msg" style="display:none" class="text-danger"></span>
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <div class="container">
                              <h4 class="box-title text-info">Buyer Information : </h4>
                           </div>
                           <hr>
                           <label for="company_name" class="col-sm-2 control-label"><?= $this->lang->line('company_name'); ?> </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="company_name" name="company_name" placeholder="">
                              <span id="company_name_msg" style="display:none" class="text-danger"></span>
                           </div>

                           <label for="contact_person" class="col-sm-2 control-label"><?= $this->lang->line('contact_person'); ?> </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="contact_person" name="contact_person" placeholder="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="address" name="address" placeholder="">
                              <span id="address_msg" style="display:none" class="text-danger"></span>
                           </div>

                           <label for="city" class="col-sm-2 control-label"><?= $this->lang->line('city'); ?> / <?= $this->lang->line('postcode'); ?> </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="city" name="city" placeholder="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="phone" name="phone" placeholder="">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="mobile" name="mobile" placeholder="">
                           ...
                           <div class="col-sm-3">
                              <input type="email" value="<?php echo  $reference_no; ?>" class="form-control " id="email" name="email" placeholder="">
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-12 ">
                           <div class="col-sm-12">
                              <div class="box-body ">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <h4 class="box-title text-info" style="margin-left: 15px;">Beneficiary Account Details: </h4>
                                       <hr>
                                       <label for="bank_name" class="col-sm-2 control-label"><?= $this->lang->line('bank_name'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="bank_name" name="bank_name" placeholder="">
                                          <span id="bank_name_msg" style="display:none" class="text-danger"></span>
                                       </div>

                                       <label for="beneficiary_name" class="col-sm-2 control-label"><?= $this->lang->line('beneficiary_name'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="beneficiary_name" name="beneficiary_name" placeholder="">
                                          <span id="beneficiary_name_msg" style="display:none" class="text-danger"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="beneficiary_account" class="col-sm-2 control-label"><?= $this->lang->line('beneficiary_account'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="beneficiary_account" name="beneficiary_account" placeholder="">
                                          <span id="beneficiary_account_msg" style="display:none" class="text-danger"></span>
                                       </div>

                                       <label for="iban_no" class="col-sm-2 control-label"><?= $this->lang->line('iban_no'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="iban_no" name="iban_no" placeholder="">
                                          <span id="iban_no_msg" style="display:none" class="text-danger"></span>
                                       </div>
                                    </div>

                                    <div class="form-group">
                                       <label for="branch" class="col-sm-2 control-label"><?= $this->lang->line('branch'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="branch" name="branch" placeholder="">
                                          <span id="branch_msg" style="display:none" class="text-danger"></span>
                                       </div>

                                       <label for="swift_code" class="col-sm-2 control-label"><?= $this->lang->line('swift_code'); ?> </label>
                                       <div class="col-sm-3">
                                          <input type="text" value="<?php echo  $reference_no; ?>" class="form-control " id="swift_code" name="swift_code" placeholder="">
                                          <span id="swift_code_msg" style="display:none" class="text-danger"></span>
                                       </div>
                                    </div>
                                       ...
                                       <tbody>
                                          ...
                                          if (isset($sales_id)) {
                                             ...
                                             if ($q3->num_rows() > 0) {
                                                ...
                                                echo "<tr class='text-right text-bold'><td colspan='4' >Total</td><td data-rowcount='$i' id='paid_amt_tot'>" . number_format($total_paid, 3, '.', '') . "</td><td></td></tr>";
                                             } else {
                        ...
                        <div class="col-xs-12 ">
                           <div class="col-sm-12">
                              <div class="box-body ">
                                 <div class="col-md-12">
                                    <h4 class="box-title text-info" style="margin-left: 15px;">Payment terms and other conditions: </h4>
                                    <hr>
                                    <div id="termsContainer">
                                       <!-- Fields will be dynamically added here -->
                                    </div>
                                    <div class="col-md-12">
                                       <button id="addTermsBtn" type="button" class="btn btn-primary">Add Terms</button>
                                       <button id="editTermsBtn" type="button" class="btn btn-warning">Edit Terms</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
   ...
   <script>
      ...
      // Function to toggle between adding and editing terms
      function toggleEditMode() {
         const termsFields = $('.terms-field');

         isEditing = !isEditing;

         termsFields.prop('disabled', !isEditing);
      }

      function addTermsField(terms) {
         const termsContainer = $('#termsContainer');
         const index = termsContainer.children().length + 1;

         const newField = $(`
            <div class="form-group">
                <label for="bank_name" class="col-sm-1 control-label">${index}. </label>
                <div class="col-sm-10">
                    <input type="text" class="form-control terms-field" id="bank_name_${index}" name="terms[]" placeholder="" value="${terms}" >
                    <span id="bank_name_msg_${index}" style="display:none" class="text-danger"></span>
                </div>
            </div>
        `);

         termsContainer.append(newField);
      }

      $('#addTermsBtn').on('click', function() {
         addTermsField('');
      });

      $('#editTermsBtn').on('click', function() {
         toggleEditMode();
      });

      $(document).ready(function() {
         const termsFromDatabase = [
            "75 % - USD 00000 advance credited to WhiteKems IMPORT EXPORT OFFIECES COMPANY",
            "25 % - USD 00000 balance upon receipt of scan copy of all commercial and shipping documents.",
            "All prices quoted are in US $ dollars",
            "Any changes in shipping cost or insurance rate are for account of the buyer.",
            "Above rates are valid for a period of 5 days only from the date of offer.",
            "Destination customs clearance is the responsibility of the consignee.",
            "WHITEKEMS liability ends once containers are discharged at the port of discharge."
         ];

         termsFromDatabase.forEach((term) => {
            addTermsField(term);
         });

         toggleEditMode(); // Disable fields initially
      });
   </script>
