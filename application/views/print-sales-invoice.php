...
<table align="center" width="100%" height='100%'>
    ...
    <tr>
        ...
        <!--<th colspan="4" rowspan="1"><b
                    style="text-transform: capitalize;"><?/*= $this->lang->line('sales_invoice'); */?> </b>(<?/*= $sales_status; */?>
            )
        </th>-->
    ...
    <tr>
        ...
        <!--<th colspan="2" rowspan="1"><?/*= $this->lang->line('date'); */?>
            : <?php /*echo show_date($sales_date) . " " . $created_time; */?></th>-->
    </tr>
    ...
    <tr>
        ...
        <td colspan="4" style="padding-left: 15px;">
            <b><?= $this->lang->line('customer_po'); ?></b><br/>
            <?php /*echo $this->lang->line('name') . ": " . $customer_name; */?><br/>
            <?php /*echo (!empty(trim($customer_mobile))) ? $this->lang->line('mobile') . ": " . $customer_mobile . "<br>" : ''; */?>
