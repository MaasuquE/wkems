                    ...
                    <div class="col-sm-12">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?= $i++; ?></td>
                            <td><?= $this->lang->line('rap_payment'); ?></td>
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="rap_payment"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                              <input type="hidden" name="module[rap_payment]" value="on">
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_payment_all" id='rap_payment_add' name="permission[rap_payment_add]"> <?= $this->lang->line('add'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_payment_all" id='rap_payment_edit' name="permission[rap_payment_edit]"> <?= $this->lang->line('edit'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_payment_all" id='rap_payment_delete' name="permission[rap_payment_delete]"> <?= $this->lang->line('delete'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_payment_all" id='rap_payment_view' name="permission[rap_payment_view]"> <?= $this->lang->line('view'); ?>
                                </label></div>
                          ...
                          <tr>
                            <td><?= $i++; ?></td>
                            <td><?= $this->lang->line('rap_reciept'); ?></td>
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="rap_reciept"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                              <input type="hidden" name="module[rap_reciept]" value="on">
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_reciept_all" id='rap_reciept_add' name="permission[rap_reciept_add]"> <?= $this->lang->line('add'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_reciept_all" id='rap_reciept_edit' name="permission[rap_reciept_edit]"> <?= $this->lang->line('edit'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_reciept_all" id='rap_reciept_delete' name="permission[rap_reciept_delete]"> <?= $this->lang->line('delete'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="rap_reciept_all" id='rap_reciept_view' name="permission[rap_reciept_view]"> <?= $this->lang->line('view'); ?>
                                </label></div>
                          ...
                          <tr>
                            <td><?= $i++; ?></td>
                            <td><?= $this->lang->line('petty_cash'); ?></td>
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="petty_cash"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                              <input type="hidden" name="module[petty_cash]" value="on">
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="petty_cash_all" id='petty_cash_add' name="permission[petty_cash_add]"> <?= $this->lang->line('add'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="petty_cash_all" id='petty_cash_edit' name="permission[petty_cash_edit]"> <?= $this->lang->line('edit'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="petty_cash_all" id='petty_cash_delete' name="permission[petty_cash_delete]"> <?= $this->lang->line('delete'); ?>
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="petty_cash_all" id='petty_cash_view' name="permission[petty_cash_view]"> <?= $this->lang->line('view'); ?>
                                </label></div>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="reports_all" id='services_report' name="permission[services_report]"> <?= $this->lang->line('services_report'); ?>
                                </label></div>
                            </td>
                          </tr>
                        </tbody>
