 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 7 ).footer() ).html(app_number_format(totol.toFixed(3)));
            $( api.column( 8 ).footer() ).html(app_number_format(paid.toFixed(3)));
            $( api.column( 9 ).footer() ).html(app_number_format(due.toFixed(3)));
