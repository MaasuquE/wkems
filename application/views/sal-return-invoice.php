        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped records_table table-bordered">
            ...
            <tr>
              ...
              <th  style="display: none;"><?= $this->lang->line('tax'); ?></th>
              <th style="display: none;" ><?= $this->lang->line('tax_amount'); ?></th>
            ...
            <tbody>
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td class='text-right'>".$CI->currency(number_format(($res2->price_per_unit * $res2->return_qty),3,'.',''))."</td>";
                  
                  echo "<td style=\"display: none;\">".$res2->tax."%<br>".$res2->tax_name."[".$str."]</td>";
                  echo "<td style=\"display: none;\"class='text-right'>".$CI->currency($res2->tax_amt)."</td>";
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td  style="display: none;"><?= $CI->currency(number_format($tot_tax_amt,3,'.',''));?></td>
                <td>-</td>
