...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search reciept</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>rap_reciept/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_rap_reciept'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('rap_reciept_date'); ?></th>
                  <th><?= $this->lang->line('rap_reciept_no'); ?></th>
                  <th><?= $this->lang->line('rap_reciept_customer_name'); ?></th>
                  <th><?= $this->lang->line('rap_reciept_sum_of'); ?></th>
                  <th><?= $this->lang->line('rap_reciept_on_bank'); ?></th>
                  <th><?= $this->lang->line('rap_reciept_cash_or_check_no'); ?></th>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('rap_reciept/ajax_list')?>",
            "type": "POST",
