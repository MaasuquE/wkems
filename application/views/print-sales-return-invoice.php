...
<table align="center" width="100%" height='100%'>
    ...
    <tr>
        <th colspan="4" rowspan="2" style="padding-left: 15px;">
        ...
        <th colspan="4" rowspan="1"><b
                    style="text-transform: capitalize;"><?= $this->lang->line('sales_invoice'); ?> </b>(<?= $return_status; ?>
            )
        </th>
    ...
    <tr>
        ...
        <th colspan="2" rowspan="1"><?= $this->lang->line('date'); ?>
            : <?php echo show_date($return_date) . " " . $created_time; ?></th>
    </tr>
    ...
    <tr>
        ...
        <th style="display: none;" rowspan='2'><?= $this->lang->line('tax'); ?></th>
        <th style="display: none;" rowspan='2'><?= $this->lang->line('tax_amount'); ?></th>
    ...
    <tr>
        ...
        foreach ($q2->result() as $res2) {
            ...
            echo "<td style=\"display: none;\">" . $res2->tax . "%<br>" . $res2->tax_name . "</td>";
            echo "<td style='text-align: right; display: none;'>" . $res2->tax_amt . "</td>";
    ...
    <tr>
        ...
        <td colspan="1" style="text-align: right;display: none;"><b><?php echo number_format(($tot_tax_amt), 3, '.', ''); ?></b></td>
        <td colspan="1" >-</td>
        <td colspan="1" style="text-align: right;"><b><?php echo number_format(($tot_discount_amt), 3, '.', ''); ?></b>
        </td>
        <td colspan="1" style="text-align: right;">
            <b><?php echo number_format(($tot_unit_total_cost), 3, '.', ''); ?></b></td>
    ...
    <tr>
        ...
        <td colspan="1" style="text-align: right;"><b><?php echo number_format(round($subtotal), 3, '.', ''); ?></b>
        </td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: right;"><b><?= $this->lang->line('other_charges'); ?></b></td>
        <td colspan="1" style="text-align: right;">
            <b><?php echo number_format(round($other_charges_amt), 3, '.', ''); ?></b></td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: right;"><b><?= $this->lang->line('discount_on_all'); ?>
                (<?= $discount_to_all_input . " " . $discount_to_all_type; ?>)</b></td>
        <td colspan="1" style="text-align: right;">
            <b><?php echo number_format(round($tot_discount_to_all_amt), 3, '.', ''); ?></b></td>
    </tr>
    <tr>
        <td colspan="7" style="text-align: right;"><b><?= $this->lang->line('grand_total'); ?></b></td>
        <td colspan="1" style="text-align: right;"><b><?php echo number_format(round($grand_total), 3, '.', ''); ?></b>
        </td>
    </tr>
    <tr>
        <td colspan="8">
