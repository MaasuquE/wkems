...
class Rap_reciept_model extends CI_Model {

	//Datatable start
	var $table = 'db_rap_reciept as a';
	var $column_order = array('a.rap_reciept_no','a.id','a.rap_reciept_date','a.rap_reciept_customer_name','a.rap_reciept_sum_of','a.rap_reciept_on_bank','a.rap_reciept_cash_or_check_no','a.rap_reciept_beign_of','c.customer_name'); //set column field database for datatable orderable
	var $column_search = array('a.rap_reciept_no','a.id','a.rap_reciept_date','a.rap_reciept_customer_name','a.rap_reciept_sum_of','a.rap_reciept_on_bank','a.rap_reciept_cash_or_check_no','a.rap_reciept_beign_of','c.customer_name'); //set column field database for datatable searchable 
	...
	private function _get_datatables_query()
	{
		...
		$this->db->where('c.id=a.rap_reciept_customer_name');
	...
	public function verify_and_save(){
		...
		$rap_reciept_date = date('Y-m-d',strtotime($rap_reciept_date));
		...
		if( $rap_reciept_no == ''){
			...
			$qs4="select coalesce(max(id),0)+1 as maxid from db_rap_reciept";
			$q1=$this->db->query($qs4);
			$maxid=$q1->row()->maxid;
			$rap_reciept_no=$service_init.str_pad($maxid, 4, '0', STR_PAD_LEFT);
		}
		
		//end

		$query1="insert into db_rap_reciept(rap_reciept_date,rap_reciept_kd,rap_reciept_fils,rap_reciept_no,rap_reciept_customer_name,rap_reciept_sum_of,
		rap_reciept_on_bank,rap_reciept_cash_or_check_no,rap_reciept_beign_of,
											system_ip,system_name,
											created_date,created_time,created_by)
											values('$rap_reciept_date','$rap_reciept_kd','$rap_reciept_fils','$rap_reciept_no','$rap_reciept_customer_name','$rap_reciept_sum_of',
											'$rap_reciept_on_bank','$rap_reciept_cash_or_check_no','$rap_reciept_beign_of',
											'$SYSTEM_IP','$SYSTEM_NAME',
											'$CUR_DATE','$CUR_TIME','$CUR_USERNAME')";
	...
	public function get_details($id,$data){
		...
		$query=$this->db->query("select * from db_rap_reciept where upper(id)=upper('$id')");
		if($query->num_rows()==0){
			show_404();exit;
		}
		else{
			$query=$query->row();
			$data['q_id']=$query->id;
			$data['rap_reciept_date']=$query->rap_reciept_date;
			$data['rap_reciept_kd']=$query->rap_reciept_kd;
			$data['rap_reciept_fils']=$query->rap_reciept_fils;
			$data['rap_reciept_no']=$query->rap_reciept_no;
			$data['rap_reciept_customer_name']=$query->rap_reciept_customer_name;
			$data['rap_reciept_sum_of']=$query->rap_reciept_sum_of;
			$data['rap_reciept_on_bank']=$query->rap_reciept_on_bank;
			$data['rap_reciept_cash_or_check_no']=$query->rap_reciept_cash_or_check_no;
			$data['rap_reciept_beign_of']=$query->rap_reciept_beign_of;


			$query_cus=$this->db->query("select customer_name from db_customers where upper(id)=upper('".$query->rap_reciept_customer_name."')");
	...
	public function update_rap_reciept(){
		...
		$rap_reciept_date = date('Y-m-d',strtotime($rap_reciept_date));
		$query1="update db_rap_reciept set 
		rap_reciept_date='$rap_reciept_date',
		rap_reciept_kd='$rap_reciept_kd',
		rap_reciept_fils='$rap_reciept_fils',
		rap_reciept_no='$rap_reciept_no',
		rap_reciept_customer_name='$rap_reciept_customer_name',
		rap_reciept_sum_of='$rap_reciept_sum_of',
		rap_reciept_on_bank= '$rap_reciept_on_bank',
		rap_reciept_cash_or_check_no= '$rap_reciept_cash_or_check_no',
		rap_reciept_beign_of='$rap_reciept_beign_of'
		where id=$q_id";
		if ($this->db->simple_query($query1)){
	...
	public function update_rap_reciept_not_admin(){
		//Filtering XSS and html escape from user inputs 
		extract($this->security->xss_clean(html_escape(array_merge($this->data,$_POST))));


		$query1="update db_rap_reciept set 
		rap_reciept_status='$rap_reciept_status',
		rap_reciept_stock_used= '$rap_reciept_stock_used',
		rap_reciept_invoice_no= '$rap_reciept_invoice_no',
		rap_reciept_remarks='$rap_reciept_remarks'
		where id=$q_id";
		if ($this->db->simple_query($query1)){
				$this->session->set_flashdata('success', 'Success!! Job Updated Successfully!');
				return "success";
	...
	public function update_status($id,$status){
        ...
        $query1="update db_rap_reciept set status='$status' where id=$id";
        if ($this->db->simple_query($query1)){
            echo "success";
        }
        else{
	...
	public function delete_rap_reciept_from_table($ids){
	
		$query1="delete from db_rap_reciept where id in($ids) ";
        if ($this->db->simple_query($query1)){
            echo "success";
        }
        else{
	...
	public function show_pay_now_modal($customer_id){
		...
		$q2=$this->db->query("select * from db_rap_reciept where id=$customer_id");
		$res2=$q2->row();
