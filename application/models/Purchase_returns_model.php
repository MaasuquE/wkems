...
class Purchase_returns_model extends CI_Model {
	...
	public function delete_return($ids){
		...
		$q6 = $this->db->select("item_id")->from("db_purchaseitemsreturn")->where("return_id in ($ids)")->get();
		if($q6->num_rows()>0){
			$this->load->model('pos_model');				
	...
	public function return_row_with_data($rowcount,$info){
		...
		?>
            <tr id="row_<?=$rowcount;?>" data-row='<?=$rowcount;?>'>
               ...
               <!-- TAX -->
               <td style="display: none;" id="td_<?=$rowcount;?>_15">
               ...
               <!-- Tax Amount -->
               <td style="display: none;"  id="td_<?=$rowcount;?>_5"><input type="text" name="td_data_<?=$rowcount;?>_5" id="td_data_<?=$rowcount;?>_5" class="form-control text-right no-padding only_currency text-center" readonly  value="<?=$item_tax_amt;?>"></td>
		    ...
		    <div class="row">
		      <div class="col-md-12">
		      	<div class="row invoice-info">
			        ...
			        <!-- /.col -->
			        <div class="col-sm-4 invoice-col">
			          <b>Paid Amount :<span><?php echo number_format($paid_amount,3,'.',''); ?></span></b><br>
			          <b>Due Amount :<span id='due_amount_temp'><?php echo number_format($due_amount,3,'.',''); ?></span></b><br>
