$('#services_customer_name').change(function (e) { 
	var v = $('#services_customer_name').val();
...
$('#save,#update').click(function (e) {
	...
	//check_field("services_customer_name");
	//check_field("mobile");
	//check_field("state");
    ...
    if(this_id=="save")  //Save start
    {
					...
					if(confirm("Do You Wants to Save Record ?")){
						e.preventDefault();
						data = new FormData($('#services-form')[0]);//form name
						/*Check XSS Code*/
...
//Delete Record start
function delete_services(q_id)
{
	
   if(confirm("Do You Wants to Delete Record ?")){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
   $.post("services/delete_services",{q_id:q_id},function(result){
  // alert(result);return;
	   if(result=="success")
				{
